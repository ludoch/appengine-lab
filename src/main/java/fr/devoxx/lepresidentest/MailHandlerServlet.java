...
/**
 * Reception d'un mail, réccupère le mail de l'envoyeur, et le contenu du
 * message. Ajoute le commentaire, et réponds au mail pour indiquer le succès de
 * l'ajout
 *
 * @author sfeir
 *
...
public class MailHandlerServlet extends HttpServlet {
    ...
    /**
     * Récupère le contenu du Message : Le type du contenue est du Type
     * Multipart, on récupère ensuite le contenu de la première partie
     *
     * @param message
     * @return
     * @throws IOException
