...
public class Counter {
    ...
    /**
     * Incrémente le compteur directement dans la mémoire cache, puis stocke la
     * valeur dans la base
     *
     * @param name
     */
    ...
    /**
     * Récupère la valeur du compteur Regarde si la valeur est dans le cache
     * mémoire sinon va calculer la valeur du compteur et la stocker dans le
     * cache
     *
     * @param name
     * @return
    ...
    /**
     * Stocke la valeur dans un compteur en choisissant un compteur aléatoire
     * sur les 10 compteurs
     *
     * @param name
     * @param value
     */
